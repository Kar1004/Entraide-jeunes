...
function Signup(props) {
  ...
  return (
    <div>
      <h1 className="text-center m-3 text-uppercase">Inscription : </h1>
      <div className="signupForm">
        ...
        <div className="ImageSignup bg-dark rounded-pill d-flex flex-column align-items-center">
          <img src={SignImg} alt="Ami encourgeant son ami" class="ImgSign" />
          <div class="messageSign text-white">
            <p>
              Ah ,tu es déjà des notre !{" "}
              <Link to="/login" class="fs-5">
                <BeachAccessTwoToneIcon aria-label="connection" />
              </Link>
            </p>
          </div>
        </div>
